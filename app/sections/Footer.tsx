          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h4 className="text-xl font-bold">New Bombay</h4>
...
15B, Gandhi Vihar Rd, Manyawas, Mansarovar, Jaipur, Rajasthan 302021                  </p>
                </div>
                ...
                >
                  ...
                  <span>WhatsApp: 099822 99987</span>
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-slate-500 text-sm">
              © {new Date().getFullYear()} New Bombay Motor Driving School. All rights reserved.
            </p>
